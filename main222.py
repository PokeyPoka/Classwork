...
print (text)[0:5]# Выводит подстроку text от 0 символа до 5
print (text)[4:10]# Выведет строку от 4 символа до 10
...
print(text)[-1]* # Выведет 10 Восклицательных знаков